...
<style type="text/css">
	...
	<?php
		...
		$sql = sprintf("SELECT * FROM `cross_route_engagement`,`cross_route_epreuve` WHERE `cross_route_engagement`.`id_epreuve` = `cross_route_epreuve`.`id_epreuve` AND `cross_route_epreuve`.`id_competition`=%s",
		...
		echo '<p><a href="export_logica.php?competition='. $_GET['competition'] .'"><img src="../images/logica.jpg" title="exporter pour logica" border="0" width="49" height="48"></a>';
		echo '<a href="export_emails.php?competition='   . $_GET['competition'] .'"><img src="../images/email.jpg" title="exporter les emails" border="0" width="49" height="48"></a>';
		echo '  <a href="export_excel.php?competition='  . $_GET['competition'] .'"><img src="../images/excel.jpg" title="exporter pour excel" border="0" width="49" height="48"></a>';
		echo '<br /><p/> ';
